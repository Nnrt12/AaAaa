...
<head>
    ...
    <title>Deposit Success - <?php echo htmlspecialchars($site_name); ?></title>
    <style>
...
<body>
    <div class="success-container">
        ...
        <p class="success-message">
            Your deposit has been processed successfully. The funds will be added to your account once the payment is confirmed on the blockchain.
        </p>
